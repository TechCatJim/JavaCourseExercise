...
public class Datasource {
    ...
    public static final String USER_NAME = "JamesChung";
    public static final String CONNECTION_STRING = "jdbc:sqlite:/Users/" + USER_NAME + "/Desktop/MusicDB/"
            + DB_NAME;
    ...
    public static final String QUERY_ALBUMS_BY_ARTIST_START = "SELECT " + TABLE_ALBUMS + '.' + COLUMN_ALBUM_NAME
            ...
            + "." + COLUMN_ARTIST_ID + " WHERE " + TABLE_ARTISTS + "."
            + COLUMN_ARTIST_NAME + " = \"";

    public static final String QUERY_ALBUM_BY_ARTIST_SORT = " ORDER BY " + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME
            + " COLLATE NO" +
            "CASE ";
    ...
    public static final String CREATE_ARTIST_FOR_SONG_VIEW = "CREATE VIEW IF NOT EXISTS " +
            ...
            TABLE_ALBUMS + "." + COLUMN_ARTIST_NAME + " AS " + COLUMN_SONG_ALBUM + ", " + TABLE_SONGS +
    ...
    public void insertSong(int track, String title, String artist, String album) {
        try {
            ...
            try {
                ...
                System.out.println("Roll back fail: " + e2.getMessage());
            }
        } finally {
            try {
